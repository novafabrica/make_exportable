...
If you have a general columns, scopes, and conditions you will be calling in multiple methods you can attach them to the <em>make_exportable</em> method as defaults when including it into your class.  These are defaults which can still be overridden when you perform an export.
...
<em>to_#{format}_export</em>
<em>create_#{format}_report</em>
