 ...
 * as - array of columns names and methods to be exported. This defaults to all columns minus salt and hashed_password and password
...
== INFO
  ...
  License: Copyright 2010 by Kevin Skoglund. 
           released under the attached MIT-LICENSE. 
           See the LICENSE file included in the distribution.
  GitHub: <a href="http://github.com/Novafabrica/make_exportable/tree/master">http://github.com/Novafabrica/make_exportable/tree/master</a>
