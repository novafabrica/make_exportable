 ...
 * columns - array of columns names and methods to be exported. This defaults to all columns minus salt and hashed_password and password
...
<tr><td>License:</td><td>Copyright 2010 by Kevin Skoglund. released under the attached MIT-LICENSE. See the LICENSE file included in the distribution.
</td></tr>
